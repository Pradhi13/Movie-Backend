...
public class MovieRestControllerTest {
    ...
    public void list() throws Exception {
        ...
        movie1.setPoster_path("meter.jpg");
        movie1.setRelease_date("2017");

        Movie movie2 = new Movie();
        movie2.setimdbid("imdb2");
        movie2.setTitle("Gladiator");
        movie2.setPoster_path("gladiator.jpg");
        movie2.setRelease_date("2013");
    ...
    public void getMovie() throws Exception {
        ...
        movie.setPoster_path("meter.jpg");
        movie.setRelease_date("2015");
